...
__global__ void batched_nvfp4_gemv_kernel_small_k(__half* __restrict__ c_ref, int m, int k, int l, const __grid_constant__ CUtensorMap tensor_map_a,
    ...
    __shared__ alignas(16) uint32_t a_smem[NUM_WARPS_PER_CTA*RESULTS_PER_WARP_SMALL][K_BLOCK_SIZE_SMALL/8];
    __shared__ alignas(16) uint16_t sfa_smem[NUM_WARPS_PER_CTA*RESULTS_PER_WARP_SMALL][K_BLOCK_SIZE_SMALL/32];
    __shared__ alignas(16) uint32_t b_smem[K_BLOCK_SIZE_SMALL/8];
    __shared__ alignas(16) uint16_t sfb_smem[K_BLOCK_SIZE_SMALL/32];
...
torch::Tensor batched_nvfp4_gemv(torch::Tensor a_ref, torch::Tensor b_ref, torch::Tensor sfa_ref, torch::Tensor sfb_ref, 
    ...
    bool small_k_true = (k < 16384 && k%K_BLOCK_SIZE_SMALL == 0);
