...
"""
Faster overlapped epilogue + change to memcpyAsync to overlap cuda driver overhead of memcpy and kernel launch
"""
            ...
            if (update_group) {
                ...
                if (elect_one_sync()) {
                    ...
                    asm volatile(
                        "tensormap.replace.tile.global_dim.shared::cta.b1024.b32 [%0], %1, %2;"
                        :
                        : "r"(local_C_tmap_addr), "n"(1), "r"(groups[group].M)
                    );
                    ...
                    asm volatile(
                        "tensormap.replace.tile.global_address.shared::cta.b1024.b64 [%0], %1;"
                        :
                        : "r"(local_C_tmap_addr), "l"(groups[group].C_addr)
                    );
                ...
                asm volatile(
                    "tensormap.cp_fenceproxy.global.shared::cta.tensormap::generic.release.gpu.sync.aligned [%0], [%1], 128;"
                    :
                    : "l"(g_C_tmap), "r"(local_C_tmap_addr)
                );
                asm volatile(
                    "fence.proxy.tensormap::generic.acquire.gpu [%0], 128;"
                    :
